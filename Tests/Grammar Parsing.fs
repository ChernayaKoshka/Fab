        ...
        [ testList "terminal execution test"
              ([ (Terminals [ 'a'; 'b'; 'c' ],
               ...
               |> List.map (fun (element, ruleStream, expected) ->
                   testCase
                       (sprintf "terminal parsing test: %A"
                            expected)
                   <| fun _ ->
                       let res =
                           matchElements [] ruleStream
                               [ element ]
          ...
          testList "repetition execution tests"
              [ testList
                  "terminal Any repetition parsing test"
                    ([ (Repetition
                            (Any,
                             Terminals [ 'a'; 'b'; 'c' ]),
                        { Text = "abcabc"
                     ...
                     |> List.map (fun (element, ruleStream, expected) ->
                         testCase
                             (sprintf
                                 "terminal Any repetition parsing test: %A"
                                  expected)
                         <| fun _ ->
                             let res =
                                 matchElements []
                ...
                testList
                    "terminal AtLeast repetition parsing test"
                    ([ (Repetition
                            (AtLeast 1uy,
                             Terminals [ 'a'; 'b'; 'c' ]),
                        { Text = "abcabc"
                     ...
                     |> List.map (fun (element, ruleStream, expected) ->
                         testCase
                             (sprintf
                                 "terminal AtLeast repetition parsing test: %A"
                                  expected)
                         <| fun _ ->
                             let res =
                                 matchElements []
                ...
                testList
                    "terminal AtMost repetition parsing test"
                    ([ (Repetition
                            (AtMost 1uy,
                             Terminals [ 'a'; 'b'; 'c' ]),
                        { Text = "abcabc"
                     ...
                     |> List.map (fun (element, ruleStream, expected) ->
                         testCase
                             (sprintf
                                 "terminal AtMost repetition parsing test: %A"
                                  expected)
                         <| fun _ ->
                             let res =
                                 matchElements []
                ...
                testList
                    "terminal Exactly repetition parsing test"
                    ([ (Repetition
                            (Exactly 1uy,
                             Terminals [ 'a'; 'b'; 'c' ]),
                        { Text = "abcabc"
                     ...
                     |> List.map (fun (element, ruleStream, expected) ->
                         testCase
                             (sprintf
                                 "terminal Exactly repetition parsing test: %A"
                                  expected)
                         <| fun _ ->
                             let res =
                                 matchElements []
                ...
                testList
                    "terminal Between repetition parsing test"
                    ([ (Repetition
                            (Between(1uy, 7uy),
                             Terminals [ 'a'; 'b'; 'c' ]),
                        { Text = "abcabc"
                     ...
                     |> List.map (fun (element, ruleStream, expected) ->
                         testCase
                             (sprintf
                                 "terminal Between repetition parsing test: %A"
                                  expected)
                         <| fun _ ->
                             let res =
                                 matchElements []
          ...
          testList "optional sequence execution test"
              ([ (OptionalSequence
               ...
               |> List.map (fun (element, ruleStream, expected) ->
                   testCase
                       (sprintf
                           "optional sequence execution test: %A"
                            expected)
                   <| fun _ ->
                       let res =
                           matchElements [] ruleStream
          ...
          testList "alternatives execution test"
              ([ (Alternatives
               ...
               |> List.map (fun (element, ruleStream, expected) ->
                   testCase
                       (sprintf
                           "optional sequence execution test: %A|%A"
                            expected element)
                   <| fun _ ->
                       let res =
                           matchElements [] ruleStream
